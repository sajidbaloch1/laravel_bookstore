                            ...
                            <a href="{{ route('book-detail', $book->id) }}" style="text-decoration: none">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <p class="text-danger"> <span class="text-success fw-bold">Rs
                                            </span>{{ $book->price }} <br>
                                            <span class="text-dark fw-bold"> {{ $book->author->name }}</span>
                                        </p>
                            </a>
        ...
        <div class="container pt-5">
            <div class="row pt-5">
                <div class="col-lg-12 mt-5">
                    ...
                    <p class="text-light mt-5">"Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, tempora
                        rerum. Magnam quod natus atque iste aspernatur ratione culpa, placeat incidunt illum debitis
                        consequatur asperiores accusamus dolorem explicabo consectetur similique cupiditate, nemo neque
                        deserunt modi obcaecati iusto sed illo quasi. Minus unde tempora, repudiandae a dignissimos dolorum
                        quae at dolore."</p>
                </div>
            </div>
        </div>
